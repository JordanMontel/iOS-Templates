...
class GET___FILEBASENAMEASIDENTIFIER___Request {
    ...
    static func buildRequest(anID: String, parameters: [String: Any], completionHandler: @escaping ([Any]?, Error?, HTTPURLResponse?) -> ()) {
        ...
        // Build request
        Alamofire.request(RESTClient.get(path: path, parameters: parameters)).validate(statusCode: 200..<300).responseJSON { response in
